            ...
            <li class="submenu">
                ...
                <div id="carrito" class="row border border-2 border-primary">
                    <div class="col-xs-12">
                        ...
                        <a href="#" id="cargarCompraLS" class="col-12  mb-2 btn btn-primary btn-lg">Cargar Compra LS</a>
                        <a href="#" id="cargarCompraEQUIPO" class="col-12  mb-2 btn btn-primary btn-lg">Cargar Compra Equipo</a>
                    </div> <!-- Fin col-xs-12 -->
                </div>
            </li>
        </ul>
