...
$rol = 'cocina';
$orden = "SELECT * FROM usuario WHERE rol = '$rol' ORDER BY rol";
if (isset($_GET["orderby"])) {
    $rol = $sql->real_escape_string($_GET["orderby"]);
    if ($rol === 'cocina' || $rol === 'reparto') {
        $orden = "SELECT * FROM usuario WHERE rol = '$rol' ORDER BY rol";
    }
}
...
if (isset($_GET['buscar'])) {
    $cuentaBusqueda = $sql->real_escape_string($_GET['buscar']);
    $orden = "SELECT * FROM usuario WHERE (rol = 'cocina' OR rol = 'reparto') AND cuenta LIKE ?";
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <div id="blog" class="container-fluid bg-dark text-light py-5 text-center wow fadeIn">
        <br><br>
        <h2 class="section-title py-5">Personal de servicio</h2>

        <div class="row justify-content-center">
            <div class="col-sm-7 col-md-4 mb-5">
                <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="nuevo_prof.php">Añadir nuevo empleado</a>
                    </li>
                </ul>
                <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="pills-hamburguesas-tab" href="profesional.php?orderby=cocina" role="tab" aria-controls="cocina" aria-selected="true">Cocina</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-bocadillos-tab" href="profesional.php?orderby=reparto" role="tab" aria-controls="reparto" aria-selected="false">Reparto</a>
                    </li>
                </ul>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-white"><?php echo htmlspecialchars($organiza["rol"]); ?></p>
                             
                                <ul class="navbar-nav">
                                <li class="nav-item">
                                        <a class="nav-link" href="ver_prof.php?id=<?php echo $organiza["id"]; ?>">Ver</a>
                                    </li>
                                    <li class="nav-item">
