...
$sql = conectarBaseDatos();
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            if ($_GET["opcion"] === "insertar") {
                ...
                $registro = $sql->query("INSERT INTO `usuario` (`cuenta`, `nombre`, `apellidos`, `contrasena`, `email`, `telefono`, `ciudad`, `cp`, `calle`, `numero`, `piso`, `letra`, `rol`) VALUES ('$cuenta', '$nombre', '$apellidos', '$contrasena', '$email', '$telefono', '$ciudad', '$cp', '$calle', '$numero', '$piso', '$letra', '$rol');"); 
            }
        }
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <div id="blog" class="container-fluid bg-dark text-light py-5 text-center wow fadeIn">
        <br><br>
        <h2 class="section-title py-5">Nuevo empleado</h2>
        <div class="row justify-content-center">
            <div class="col-sm-7 col-md-4 mb-5">
                <form  method="POST" action="nuevo_prof.php?opcion=insertar" enctype="multipart/form-data">
                    <div class="form-group">
                    <label for="nombre" class="form-label">Nombre del empleado:</label>
                        <input type="text" class="form-control" id="nombre" name="nombre">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Apellidos del empleado:</label>
                        <input type="text" class="form-control" id="apellidos" name="apellidos">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Email del empleado:</label>
                        <input type="email" class="form-control" id="email" name="email">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Teléfono del empleado:</label>
                        <input type="text" class="form-control" id="telefono" name="telefono">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Ciudad del empleado:</label>
                        <input type="text" class="form-control" id="ciudad" name="ciudad">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Código postal del empleado:</label>
                        <input type="text" class="form-control" id="cp" name="cp">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Calle del empleado:</label>
                        <input type="text" class="form-control" id="calle" name="calle">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Número portal del empleado:</label>
                        <input type="text" class="form-control" id="numero" name="numero">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Nº piso, puerta... del empleado:</label>
                        <input type="text" class="form-control" id="piso" name="piso">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Letra puerta del empleado:</label>
                        <input type="text" class="form-control" id="letra" name="letra">
                    </div>
                    <div class="form-group">
                    <label for="nombre" class="form-label">Nombre usuario del empleado:</label>
                        <input type="text" class="form-control" id="cuenta" name="cuenta" required>
                    </div>

                    <div class="form-group">
                    <label for="nombre" class="form-label">Contraseña del empleado:</label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group ">
                        <button type="submit" class="form-control btn btn-primary" >Añadir nuevo empleado</button>
                    </div>
                </form>
            </div>
            </div>
