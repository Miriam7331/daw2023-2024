...
if (isset($_SESSION['cuenta'])) {
    ...
    if ($rol == 'cliente') {
        $redirect_url = 'cliente/productos.php'; // URL para clientes
    } elseif ($rol == 'boss') {
        $redirect_url = 'boss/articulos.php'; // URL para jefes
    } else {
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#blog">Recetas<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                ...
                <?php if (isset($_SESSION['cuenta'])): ?>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="<?php echo $redirect_url; ?>" class="btn btn-primary ml-xl-4">Hola, <?php echo htmlspecialchars($_SESSION["cuenta"]); ?></a>
                        </li>
                        <li class="nav-item">
                ...
                <?php else: ?>
                    <li class="nav-item">
                        <a href="login.php" class="btn btn-primary ml-xl-4">Log in</a>
                    </li>
                <?php endif; ?>
    ...
    <header id="home" class="header">
        <div class="overlay text-white text-center">
            <h1 class="display-2 font-weight-bold my-3">Pollo LOCO</h1>
            <h2 class="display-4 mb-5">Delicioso &amp; Jugoso</h2>
            <a class="btn btn-lg btn-primary" href="#gallary">Menú</a>
        </div>
    </header>
    ...
    <div class="gallary row">
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            ...
            <a href="hamburguesas.html" class="gallary-overlay">
