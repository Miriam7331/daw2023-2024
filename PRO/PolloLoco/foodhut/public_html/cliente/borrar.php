    ...
    if ($organiza) {
        ...
        if ($stmt) {
            ...
            if ($resultado) {
                ...
                echo "<script>alert('$mensaje'); window.location.href = 'clientes.php';</script>"; // Alerta de eliminación exitosa con botón de redirección
            } else {
        ...
        echo "No se ha especificado un cliente válido para eliminar.";
    }
}
?>
