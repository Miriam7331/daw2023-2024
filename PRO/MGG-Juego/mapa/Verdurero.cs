...
namespace mapa
{
    public class Verdurero : NPC
    {
        ...
        public Verdurero(int x, int y, Mapa elmapa)
        {
            this.x = x;
            this.y = y;
            this.mapa = mapa;
        ...
        private void LeerFrase()
        {
            ...
            try
            {
                using (StreamReader archivo = new StreamReader("verdurero.txt"))
                {
            ...
            {
                Console.WriteLine("Archivo verdurero.txt no encontrado.");
            }
        }
    }
}